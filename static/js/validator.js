...
var Validator = function(name)
{
  ...
  * @param :  msg         错误提示信息
  */
  this.length_1 = function(controlId,length_1, msg)
  {
    var obj = document.forms[this.formName].elements[controlId];
    if (obj.value.length!=length_1)
    {
      this.addErrorMsg(msg);
    }
  }
  ...
  * @param :  msg         错误提示信息
  */
  this.length_2 = function(controlId,length_1,length_2, msg)
  {
    var obj = document.forms[this.formName].elements[controlId];
    if (obj.value.length<length_1||obj.value.length>length_2)
    {
      this.addErrorMsg(msg);
    }
  }
  ...
  * @param : msg         错误提示信息
  */
  this.eqaul_1 = function(fstControl, str_msg, msg)
  {
    var fstObj = document.forms[this.formName].elements[fstControl];

    if (fstObj != null)
    {
      if (fstObj.value == '' || fstObj.value == str_msg)
      {
        this.addErrorMsg(msg);
      }
    }
