...
<body>
    ...
    <div class="tools">
        ...
        <li class="click"><span></span><a href="#"  style="color:red" >表名：用户信息表</a></li>
	...
	<form name="myform" action="/user_information/addview"  method="post"  enctype="multipart/form-data">
    ...
    <tbody>
		...
		<td>
		<?php if($row['Field']!="cat_id"&&$row['Field']!="user_id"&&$row['Field']!="bumen_id"&&$row['Field']!="user_name"&&$row['Field']!="password"
