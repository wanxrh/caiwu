...
<body>
    ...
    <table class="tablelist">
        ...
        <td align="center"><a href="/wageslist/add?id=<?php echo $val['zhiyuandaima'];?>" class="tablelink">添加工资记录</a>　<a href="/wageslist/viewlist?id=<?php echo $val['zhiyuandaima'];?>" class="tablelink">查看工资记录</a></td>
